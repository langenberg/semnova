...
#' @import tidyverse
#' @details \code{lgc()} is a wrapper for the R6 class constructor
#' \code{Lgc$new()}. See \code{Lgc$new()} below for a list of arguments.
#'
Lgc <- R6Class(
    "Lgc",
    private = list(
    ...
    public = list(
        ...
        #' @export
        #' @import tidyverse
        get_etas_mmodel = function() {
            private$etas_mmodel
        },

        #' @export
        #' @import tidyverse
        get_covariates_mmodel = function() {
        ...
        get_estimates = function(
            ...
            #             op == "~" ~ "regression",
            #             op == "==" ~ "constraint",
            #             op == "~~" & self$is_latent(lhs) & rhs == lhs ~ "variance",
            #             op == "~~" & self$is_latent(lhs) & rhs != lhs ~ "covariance",
            #             op == "~~" & !self$is_latent(lhs) & rhs == lhs ~ "resid_var",
            #             op == "~~" & !self$is_latent(lhs) & rhs != lhs ~ "resid_cov",
